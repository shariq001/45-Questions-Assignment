...
var album2 = myAlbum("Talha", "Balli");
var album3 = myAlbum("Younus", "Karachi");
console.log(album1);
console.log(album2);
console.log(album3);
...
var album4 = myAlbum1("Ahad", "Dunya", 30);
var album5 = myAlbum1("Talat", "Mausam", 55);
var album6 = myAlbum1("Azan", "Hyderabad");
console.log(album4);
console.log(album5);
console.log(album6);
